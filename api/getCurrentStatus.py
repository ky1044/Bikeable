...
def get_nearby_stations(lat,lon,radius,max_length):
	...
	for station in stations:
		...
		if station_distance<radius:
			...
			nearby_stations.insert(place,{"id": station.id,"name":station.name,"latitude":station.latitude,"longitude":station.longitude, "distance":station_distance,"mapsURL":MapsURL,"appURL":AppURL})
...
def get_station_status(user_latitude, user_longitude,count):
	nearby_station_list = get_nearby_stations(user_latitude, user_longitude,10000,count)
